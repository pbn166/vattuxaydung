                ...
                <main class="col-9 bg-white mx-n2">
                    ...
                    <table border="1" cellpadding="5" cellspacing="5"> 
                        ...
                        <tr>
                            ...
                            <td width="80"><?php echo $value['DanhMucSP'] ?></td>
                            <td width="100"><?php echo $value['LoaiSP'] ?></td>
                            <td ><?php echo $value['TenSP'] ?></td>
                            <td width="70"><img width="50" src="public/img/sanpham/<?php echo $value['HinhAnhSP'] ?>"></td>
                            <td width="50"><?php echo $value['MaSP'] ?></td>
                            <td><?php echo $value['NhaCungCap'] ?></td>
                            <td  width="70"><?php echo $value['XuatXu'] ?></td>
                            <td><?php echo $value['MoTa'] ?></td>
                            <td><?php echo $value['GiaSP'] ?></td>
                            <td><?php echo $value['DonViTinh'] ?></td>
                            <td>
                                
                                <button><a href="http://localhost/vatlxd/?router=admin&page=suasanpham&MaSP=<?php echo $value['MaSP'] ?>">Sửa</a></button><br><br>
                                <button class="btnxoa"  value="<?php echo $value['MaSP'] ?>" >Xóa</button>
        ...
        <script>
            ...
            for(let i = 0 ; i< btnxoa.length ; i++){
                btnxoa[i].addEventListener('click',function(e){
                    ...
                    formData.append("MaSP", a);
                    if (confirm("Bạn có muốn xóa sản phẩm") == true) {
                        fetch('http://localhost/vatlxd/modules/api/Product.php',{
                            method: 'Post',
