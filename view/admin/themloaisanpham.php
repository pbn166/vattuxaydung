...
<html>
    ...
    if (isset($_POST['btnSubmit'])) {
        ...
        $Ten = trim($_POST['ten_loaisanpham']);
        $Trangthai = trim($_POST['trangthai_loaisanpham']);
        
        
        
            if ($product->addProducttype($Ten, $Trangthai)) {
    ?>
                <script>
            ...
            ?>
                <script>
                    ...
                    window.location = "http://localhost/vatlxd/?router=admin&page=themloai";
                </script>
            <?php
                ...
                <main class="col-9 bg-white mx-n2">
                    ...
                    <form action="" method="post">
                        <table>
                            <tr>
                                <td>Tên:</td>
                                <td><input type="text" name="ten_loaisanpham"><br><br></td>
                            </tr>
                            
                            <tr>
                                <td>Trạng Thái:</td>
                                <td><input type="text" name="trangthai_loaisanpham"><br><br></td>
                            </tr>
                            <tr>
                                <td></td>
