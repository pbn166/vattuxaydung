...
<html>
    ...
    if (isset($_POST['btnSubmit'])) {
        ...
        $DonVi = trim($_POST['DonViTinh']);
            ...
            echo $NCC;
            if ($product->addProduct( $DM, $Loai, $Ten, $Hinh, $Ma, $NCC, $XX, $Mota, $Gia, $DonVi)) {
    ?>
                <script>
            ...
            ?>
                <script>
                    ...
                    window.location = "http://localhost/vatlxd/?router=admin&page=them";
                </script>
            <?php
                    ...
                    <form action="" method="post">
                        <table>
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="DanhMucSP"><br><br></td>
                            </tr>
                            
                            <tr>
                                <td>Loại Sản Phẩm:</td>
                                <td><input type="text" name="LoaiSP"><br><br></td>
                            </tr>
                            <tr>
                                <td>Tên Sản Phẩm:</td>
                                <td><input type="text" name="TenSP"><br><br></td>
                            </tr>
                            <tr>
                                <td>Hình Ảnh:</td>
                                <td><input type="text" name="HinhAnhSP"><br><br></td>
                            </tr>
                            <tr>
                                <td>Mã Sản Phẩm:</td>
                                <td><input type="text" name="MaSP"><br><br></td>
                            </tr>
                            <tr>
                                <td>Nhà Cung Cấp:</td>
                                <td><input type="text" name="NhaCungCap"><br><br></td>
                            </tr>
                            <tr>
                                <td>Xuất Xứ:</td>
                                <td><input type="text" name="XuatXu"><br><br></td>
                            </tr>
                            <tr>
                                <td>Mô Tả:</td>
                                <td><input type="text" name="MoTa"><br><br></td>
                            </tr>
                            <tr>
                                <td>Giá:</td>
                                <td><input type="text" name="GiaSP"><br><br></td>
                            </tr>
                            <tr>
                                <td>Đơn Vị Tính:</td>
                                <td><input type="text" name="DonViTinh"><br><br></td>
                            </tr>
                            <tr>
                                <td></td>
